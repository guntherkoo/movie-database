...
function (_Component) {
  ...
  function Index() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "componentDidMount", function () {
      _this.props.fetchMovieData('now_playing', 'US');
    });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Index, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("section", null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h1", null, "This is my Next.js Boilerplate."), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h2", null, this.props.count, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("button", {
        onClick: this.increment
      }, "+1"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("button", {
        onClick: this.decrement
      }, "-1")), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("button", {
        onClick: this.toggle
      }, tap ? 'Toggle Off' : 'Toggle On'), tap && react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h2", null, "Toggler is ON"));
    }
  }], [{
    key: "getInitialProps",
    value: function getInitialProps(_ref) {
      var reduxStore = _ref.reduxStore,
          req = _ref.req;
      var isServer = !!req; // const fetch_promise = Promise.resolve()
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    toggleTap: function toggleTap() {
      dispatch(_redux_actions__WEBPACK_IMPORTED_MODULE_10__["Action"].toggleTap());
    },
    incrementCount: function incrementCount() {
      dispatch(_redux_actions__WEBPACK_IMPORTED_MODULE_10__["Action"].incrementCount());
    },
    decrementCount: function decrementCount() {
      dispatch(_redux_actions__WEBPACK_IMPORTED_MODULE_10__["Action"].decrementCount());
    },
    fetchMovieData: function fetchMovieData(status, region) {
      dispatch(_redux_actions__WEBPACK_IMPORTED_MODULE_10__["Action"].fetchMovieData(status, region));
    }
  };
};
...
//# sourceMappingURL=Index.js.da1dfb03f2525bc419a5.hot-update.js.map